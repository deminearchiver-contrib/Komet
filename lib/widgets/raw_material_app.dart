...
class _RawMaterialAppState extends State<RawMaterialApp> {
  ...
  bool get _isDarkTheme => _colorScheme.brightness == .dark;
  ...
  Color get _materialColor => widget.color ?? _colorScheme.primary;
  ...
  Widget _buildDefaults(BuildContext context, Widget? child) {
    ...
    result = DefaultSelectionStyle(
      selectionColor: _colorScheme.primary.withValues(alpha: 0.4),
...
class _MaterialInspectorButton extends InspectorButton {
  ...
  Color backgroundColor(BuildContext context) {
    ...
    return switch (variant) {
      .filled => colorScheme.errorContainer,
      .iconOnly => colorScheme.surfaceContainerLowest,
      .toggle => toggledOn! ? colorScheme.error : colorScheme.errorContainer,
    };
  }
  ...
  Color foregroundColor(BuildContext context) {
    final colorScheme = ColorScheme.of(context);
    return switch (variant) {
      .filled => colorScheme.onErrorContainer,
      .iconOnly => colorScheme.error,
      .toggle =>
        toggledOn! ? colorScheme.onError : colorScheme.onErrorContainer,
    };
  }
